...
$titulo_pagina = 'Contato | Portfólio DWI';
$caminho_raiz = '../';
$nome_visitante = '';
$email = '';
$mensagem = '';
...
<body>
    ...
    <div class="campo">
        <label class="label-campo" for="mensagem"> Mensagem 
            <span style="color: #6b7280; font-weight: normal; font-size: 13px;">(mín. 10, máx. 500 caracteres)
            </span>
        </label>
        <textarea class="input-texto" id="mensagem" name="mensagem" rows="5" placeholder="Escreva sua mensagem" maxlength="500"><?php echo htmlspecialchars ($mensagem); ?></textarea>
    </div>
