 ...
 * Arquivos: 05_crud/editar.php
 * Autor: Henrique Gnatta
 * Data:11/04/2026
 * Descrição: Implementa o U do CRUD (Update) Este arquivo tem três responsibilidade:1. Validar p ID recebido via GET 2.Exibir formulario preenchido com dados atuais(GET)3. Processo as alterações e executar UPDATE (POST)
 */
...
<form action="editar.php?id=<?php echo $id; ?>" method="post" class="formulario">
            ...
            <div class="campo">
             ...
             <div class="campo">
                <label clas="label-campo"> Link GitHub (opcional) </label>
            ...
            <div class="campo">
                ...
                <input type="nuber" name="ano" class="input-texto" value="<?php echo (int) $projeto['ano']; ?>"min="2000" max="2099">
            </div>
