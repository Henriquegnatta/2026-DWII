 ...
 * Data: 04/04/2026
 * Descricao Exibe o formulario de cadastro e processa o INSET
 */
...
$titulo_pagina = 'Cadastrar Projeto -> Portifolio';
$caminho_raiz = '../';
$pagina_atual = '';
?>
<!DOCTYPE html>
...
<div class="form-container">
    <form action="cadastrar.php" method="post">
        ...
        <label for="tecnologias">Tecnologias usadas: <span style="color:red;">*</span></label>
        ...
        <input type  = "url"  id="link_github" name="link_github" value="<?php echo htmlspecialchars($form['link_github']); ?>" placeholder="https://github.com/HenriqueGnatta/2026-DWII">
