...
<body>
    <div class="container">
        ...
        font-weight: bold;">Voltar ao Catalogo</a>
        <div style="display:flex;
        justify-content:space-between;
        align-items:flex-start;">
        <h1 style="color:#3b579d;
        margin: 0 0 8px;
        font-size:24px;">
...
<tr style="background:#f3f4f6;">
    ...
    <td style="padding:10px; border: 1px #e5e7eb;">
        <?php echo $tec['id'];?>
</td>
</tr>
<tr>
    <td style="padding: 10px; border: 1 px solid #e5e7eb;font-weight:bold;">Ano de criação</td>
</td>
...
<tr style="background: #f3f4f6;">
    <td style="padding:10px; border: 1px solid #e5e7eb; font-weight:bold;">Cadastro em</td>
    <td style="padding:10px;border:1px solid #e5e7eb;">
